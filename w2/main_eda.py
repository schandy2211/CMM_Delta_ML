...
file_path = '/pscratch/sd/s/schandy/delta_learning/new_data/w2/args.txt'  # Replace with the path to text file
...
filepath_sobol = '/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/xyz/'+ele+'_sobol.xyz'
filepath_aimd = '/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/xyz/'+ele+'_meili.xyz'
...
E_eda_sobol = pd.read_csv('/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/eda_labels/'+ele+'_sobol.csv')[label]
E_eda_aimd = pd.read_csv('/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/eda_labels/'+ele+'_meili.csv')[label]

#if label_type == 'eda_aniso':
E_ff_sobol = pd.read_csv('/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/cmm_labels/'+ele+'_sobol.csv')[label]
E_ff_aimd = pd.read_csv('/pscratch/sd/s/schandy/delta_learning/new_data/dataset_v1.1/cmm_labels/'+ele+'_meili.csv')[label]
...
np.savetxt(save_path+'valid_indices.txt', valid_indices, fmt='%d')
